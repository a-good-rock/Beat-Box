...
public class BeatBox {
    ...
    public void buildGUI() {
        ...
        JButton clearInstruments = new JButton("Clear Instruments");
        clearInstruments.addActionListener(new MyClearListener());
        buttonBox.add(clearInstruments);
        ...
        JButton loadPattern = new JButton("Reload Pattern");
